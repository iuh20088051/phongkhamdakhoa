...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="image/tapchi.jpg" class="d-block w-100" alt="">
        </div>
    </div>
</div>    
<div class="vision-mission">
    <span>TTND.PGS.TS.BS LÊ HOÀNG Niềm hy vọng của hàng ngàn vợ chồng hiếm muộn</span>
TTND.PGS.TS.BS Lê Hoàng được xem là chuyên gia đầu ngành về điều trị vô sinh hiếm muộn, thành thạo nhiều kỹ thuật chẩn đoán và điều trị tiên tiến trên thế giới.
</div>
