...
<div class="vision-mission">
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/hanoi.png" alt="">
                <span>Bệnh viện Đa khoa Tâm Anh Hà Nội</span>
                <P>

                108 Phố Hoàng Như Tiếp, Phường Bồ Đề, Long Biên, Thành phố Hà Nội

                SĐT:024 3872 3872 - 024 7106 6858
                </P>
            </div>
        </div>
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/tphcm.png" alt="">
                <span>Bệnh viện Đa khoa Tâm Anh TP.HCM</span>
                <P>

                2B Phổ Quang, Phường 2, Quận Tân Bình, Thành phố Hồ Chí Minh

                SĐT: 028 7102 6789 - 093 180 6858
                </P>
            </div>
        </div>
</div>
