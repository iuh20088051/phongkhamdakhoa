...
if (!$phieukham_row) {
    echo "Mã bệnh nhân bị sai hoặc không tồn tại.";
    ...
    switch ($phieukham_row['sophongkham']) {
        case 1:
            $chi_phi = 200000;
            break;
        case 2:
    ...
    echo "<div class='info-box'>";
    echo "<h2>Chi Phí Dịch Vụ</h2>";
    echo "<p><strong>Thành Tiền:</strong> $chi_phi VNĐ</p>";
    echo "</div>";

    // Nút Trở lại
    echo "<button onclick='goBack()' class='button'>Trở lại</button>";
