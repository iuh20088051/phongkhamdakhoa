            ...
            <div class="header_right col-lg-10 col-sm-9 hidden-xs text-right">
                ...
                <div class="header_footer pt_10 flex-container">
                    ...
                    <div class="pl_15 item">
                        ...
                        <a rel="" target="_blank" href="chatbotNPC/phienban3/gd.php">
...
<div id="multiItemCarouselDifferent" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-prev" href="#multiItemCarouselDifferent" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#multiItemCarouselDifferent" role="button" data-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
