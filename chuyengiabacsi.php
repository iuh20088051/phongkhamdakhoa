...
<head>
    ...
    <style>
        ...
        .anhtieude {
    max-width: 800px; /* Giới hạn chiều rộng của phần tử chứa ảnh */
    margin: 20px auto;
    padding: 20px;
...
.anhchamhoi img {
    height: 100px; /* Điều chỉnh kích thước của ảnh */
    width: auto;
    margin-right: 20px; /* Tạo khoảng cách giữa ảnh và văn bản */
    float: left; /* Đặt ảnh về phía trái */
}
...
<div class="vision-mission">
    <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/bsdominhhung.png" alt="">
                <span>TS.BS ĐỖ MINH HÙNG</span>
                <P>
                TS.BS Đỗ Minh Hùng đã có gần 30 năm kinh nghiệm chẩn đoán và điều trị các bệnh lý tiêu hóa, đặc biệt là chuyên ngành Tiêu hóa - Gan mật. Với hàng chục năm làm việc tại các bệnh viện lớn như Bệnh viện Bình Dân, Bệnh viện FV, Bệnh viện AIH, Bệnh viện...
                </P>
            </div>
        </div>
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/bsnguyenbamynhi.png" alt="">
                <span>BS.CKII NGUYỄN BÁ MỸ NHI</span>
                <P>
                Bác sĩ Nguyễn Bá Mỹ Nhi - nguyên Phó Giám đốc phụ trách chuyên môn Bệnh viện Phụ sản Từ Dũ, Giám đốc chuyên môn Trung tâm Sản Phụ khoa - Bệnh viện Đa khoa Tâm Anh TP.Hồ Chí Minh là một trong những chuyên gia hàng đầu trong lĩnh vực Sản phụ khoa với...
            </div>
        </div>
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/bsphamnguyenvinh.png" alt="">
                <span>PGS.TS.BS PHẠM NGUYỄN VINH</span>
                <P>
                PGS.TS.BS Phạm Nguyễn Vinh là một trong những chuyên gia đầu ngành trong lĩnh vực Nội tim mạch tại Việt Nam. Sau khi tốt nghiệp Bác sĩ Y khoa chuyên khoa Tim mạch trường Đại học Y khoa Sài Gòn, bác sĩ Phạm Nguyễn Vinh sang Pháp tu nghiệp trong hai...</P>
                </P>
            </div>
        </div>
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/bstranquananh.jpg" alt="">
                <span>NGND.GS.TS.BS TRẦN QUÁN ANH</span>
                <P>
                NGND.GS.TS.BS Trần Quán Anh là người đầu tiên đặt nền móng cho ngành Nam học Việt Nam. Ông là Tổng Thư ký Hội Tiết niệu - Thận học Việt Nam, Hội viên Hội Tiết niệu thế giới (S.I.U), là người khởi xướng xây dựng phân khoa nam học, thuộc Khoa tiết...
        ...
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/bstranquangbinh.png" alt="">
                <span>PGS.TS.BS.CKII TRẦN QUANG HINH</span>
                <P>
                PGS.TS.BS.CKII Trần Văn Hinh được biết đến là một trong những chuyên gia hàng đầu trong lĩnh vực tiết niệu và ghép thận tại Việt Nam. Với hơn 30 năm kinh nghiệm trong ngành Y, PGS Hinh cập nhật và làm chủ các kỹ thuật cao trong điều trị. Ông đã thực...
                </P>
            </div>
        </div>
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/bstrieutrieuduong.png" alt="">
                <span>TSUT.PGS.TS TRIỆU TRIỀU DƯƠNG</span>
                <P>
                TTƯT.PGS.TS Triệu Triều Dương là chuyên gia hàng đầu ngành phẫu thuật tiêu hóa: phẫu thuật thực quản, dạ dày, ruột, gan mật tụy, đại trực tràng, hậu môn, sàn chậu….
            </P>
            </div>
        </div>
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/bsvulechuyen.png" alt="">
                <span>TSUT.PGS.TS.BS VŨ LÊ CHUYÊN</span>
                <P>
                TTƯT.PGS.TS.BS Vũ Lê Chuyên là một trong những người đặt nền móng đầu tiên cho ngành phẫu thuật nội soi tiết niệu tại Việt Nam. Với hơn 40 năm cống hiến cho ngành Tiết niệu - Thận học, Phó giáo sư Vũ Lê Chuyên đã đạt được nhiều thành tích và danh...
