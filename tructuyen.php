...
<div class="vision-mission">
       <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/buongtrung.jpg" alt="">
                <span>TVTT GIẢI THÍCH VỀ KÍCH THÍCH BUỒNG TRỨNG</span>
                <P>
                20h thứ 4 ngày 15/5/2024 3 chuyên gia của Trung tâm Hỗ trợ sinh sản, BVĐK Tâm Anh TP HCM sẽ tư vấn trực tuyến về giải đáp về kích thích buồng trứng tăng số lượng & chất lượng nang noãn, tối đa cơ hội thụ tinh & thụ thai. 
                </P>
            </div>
        </div>
        <div class="anhtieude">
            <div class="anhchamhoi">
                <img class="" height="26" width="auto" src="image/nhoimau.jpg" alt="">
                <span>TVTT KỸ THUẬT CAO TẦM SOÁT, ĐIỀU TRỊ ĐỘT QUỴ VÀ NHỒI MÁU CƠ TIM</span>
                <P>
                Đột quỵ và nhồi máu cơ tim có thể xảy ra ở bất kỳ độ tuổi, đối tượng nào. Bệnh có thể diễn tiến âm thầm, khởi phát đột ngột ngay cả khi người bệnh đang ngủ, sinh hoạt, hoặc làm việc
                </P>
            </div>
        </div>
</div>
